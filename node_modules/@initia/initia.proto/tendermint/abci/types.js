...
exports.RequestInitChain = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.consensusParams !== undefined) {
            params_1.ConsensusParams.encode(message.consensusParams, writer.uint32(26).fork()).join();
        }
...
exports.ResponseInitChain = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.consensusParams !== undefined) {
            params_1.ConsensusParams.encode(message.consensusParams, writer.uint32(10).fork()).join();
        }
        for (const v of message.validators) {
...
exports.ResponseQuery = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.proofOps !== undefined) {
            proof_1.ProofOps.encode(message.proofOps, writer.uint32(66).fork()).join();
        }
        if (message.height !== 0n) {
            if (BigInt.asIntN(64, message.height) !== message.height) {
                throw new gt.Error("value provided for field message.height of type int64 too large");
...
exports.ResponseListSnapshots = {
    ...
    fromJSON(object) {
        return {
            snapshots: gt.Array.isArray(object?.snapshots) ? object.snapshots.map((e) => exports.Snapshot.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.ResponseApplySnapshotChunk = {
    ...
    fromJSON(object) {
        return {
            ...
            refetchChunks: gt.Array.isArray(object?.refetchChunks) ? object.refetchChunks.map((e) => gt.Number(e)) : [],
            rejectSenders: gt.Array.isArray(object?.rejectSenders) ? object.rejectSenders.map((e) => gt.String(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.ResponseFinalizeBlock = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.consensusParamUpdates !== undefined) {
            params_1.ConsensusParams.encode(message.consensusParamUpdates, writer.uint32(34).fork()).join();
        }
        if (message.appHash.length !== 0) {
    ...
    fromJSON(object) {
        return {
            events: gt.Array.isArray(object?.events) ? object.events.map((e) => exports.Event.fromJSON(e)) : [],
            txResults: gt.Array.isArray(object?.txResults) ? object.txResults.map((e) => exports.ExecTxResult.fromJSON(e)) : [],
...
exports.ExtendedCommitInfo = {
    ...
    fromJSON(object) {
        return {
            round: isSet(object.round) ? gt.Number(object.round) : 0,
            votes: gt.Array.isArray(object?.votes) ? object.votes.map((e) => exports.ExtendedVoteInfo.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
