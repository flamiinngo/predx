...
exports.GenesisState = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.clientGenesis !== undefined) {
            genesis_2.GenesisState.encode(message.clientGenesis, writer.uint32(10).fork()).join();
        }
        if (message.connectionGenesis !== undefined) {
            genesis_3.GenesisState.encode(message.connectionGenesis, writer.uint32(18).fork()).join();
        }
        if (message.channelGenesis !== undefined) {
            genesis_1.GenesisState.encode(message.channelGenesis, writer.uint32(26).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
