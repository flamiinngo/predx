...
exports.QueryChannelResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.channel !== undefined) {
            channel_1.Channel.encode(message.channel, writer.uint32(10).fork()).join();
        }
...
exports.QueryPacketCommitmentsResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        for (const v of message.commitments) {
            channel_1.PacketState.encode(v, writer.uint32(10).fork()).join();
        }
        if (message.pagination !== undefined) {
            pagination_1.PageResponse.encode(message.pagination, writer.uint32(18).fork()).join();
        }
...
exports.QueryUnreceivedPacketsResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        writer.join();
        if (message.height !== undefined) {
            client_1.Height.encode(message.height, writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
exports.QueryUpgradeErrorResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.errorReceipt !== undefined) {
            upgrade_1.ErrorReceipt.encode(message.errorReceipt, writer.uint32(10).fork()).join();
        }
        if (message.proof.length !== 0) {
            writer.uint32(18).bytes(message.proof);
        }
...
exports.QueryChannelParamsResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.params !== undefined) {
            channel_1.Params.encode(message.params, writer.uint32(10).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
