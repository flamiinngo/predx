...
exports.FileDescriptorSet = {
    ...
    fromJSON(object) {
        return { file: gt.Array.isArray(object?.file) ? object.file.map((e) => exports.FileDescriptorProto.fromJSON(e)) : [] };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromJSON(object) {
        return {
            ...
            optionDependency: gt.Array.isArray(object?.optionDependency)
                ? object.optionDependency.map((e) => gt.String(e))
                : [],
...
exports.DescriptorProto = {
    ...
    fromJSON(object) {
        return {
            name: isSet(object.name) ? gt.String(object.name) : "",
            field: gt.Array.isArray(object?.field) ? object.field.map((e) => exports.FieldDescriptorProto.fromJSON(e)) : [],
            extension: gt.Array.isArray(object?.extension)
                ? object.extension.map((e) => exports.FieldDescriptorProto.fromJSON(e))
                : [],
...
exports.EnumDescriptorProto = {
    ...
    fromJSON(object) {
        return {
            name: isSet(object.name) ? gt.String(object.name) : "",
            value: gt.Array.isArray(object?.value) ? object.value.map((e) => exports.EnumValueDescriptorProto.fromJSON(e)) : [],
            ...
            reservedRange: gt.Array.isArray(object?.reservedRange)
                ...
                : [],
            reservedName: gt.Array.isArray(object?.reservedName) ? object.reservedName.map((e) => gt.String(e)) : [],
            visibility: isSet(object.visibility) ? symbolVisibilityFromJSON(object.visibility) : 0,
        };
    },
    toJSON(message) {
...
exports.ServiceDescriptorProto = {
    ...
    fromJSON(object) {
        return {
            name: isSet(object.name) ? gt.String(object.name) : "",
            method: gt.Array.isArray(object?.method) ? object.method.map((e) => exports.MethodDescriptorProto.fromJSON(e)) : [],
...
exports.MessageOptions = {
    ...
    fromJSON(object) {
        return {
            messageSetWireFormat: isSet(object.messageSetWireFormat) ? gt.Boolean(object.messageSetWireFormat) : false,
...
exports.FieldOptions_FeatureSupport = {
    ...
    fromJSON(object) {
        return {
            ...
            removalError: isSet(object.removalError) ? gt.String(object.removalError) : "",
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.UninterpretedOption = {
    ...
    fromJSON(object) {
        return {
            name: gt.Array.isArray(object?.name) ? object.name.map((e) => exports.UninterpretedOption_NamePart.fromJSON(e)) : [],
