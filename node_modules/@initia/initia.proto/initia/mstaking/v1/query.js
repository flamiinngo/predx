...
function createBaseQueryDelegatorDelegationsRequest() {
    return { delegatorAddr: "", pagination: undefined, status: "" };
}
...
function createBaseQueryDelegatorTotalDelegationBalanceRequest() {
    return { delegatorAddr: "", status: "" };
}
exports.QueryDelegatorTotalDelegationBalanceRequest = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.delegatorAddr !== "") {
            writer.uint32(10).string(message.delegatorAddr);
        }
    ...
    decode(input, length) {
        const reader = input instanceof wire_1.BinaryReader ? input : new wire_1.BinaryReader(input);
        const end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseQueryDelegatorTotalDelegationBalanceRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1: {
    ...
    create(base) {
        return exports.QueryDelegatorTotalDelegationBalanceRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseQueryDelegatorTotalDelegationBalanceRequest();
        message.delegatorAddr = object.delegatorAddr ?? "";
...
function createBaseQueryDelegatorTotalDelegationBalanceResponse() {
    return { balance: [] };
}
exports.QueryDelegatorTotalDelegationBalanceResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
    ...
    decode(input, length) {
        const reader = input instanceof wire_1.BinaryReader ? input : new wire_1.BinaryReader(input);
        const end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseQueryDelegatorTotalDelegationBalanceResponse();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1: {
    ...
    fromJSON(object) {
        return { balance: gt.Array.isArray(object?.balance) ? object.balance.map((e) => coin_1.Coin.fromJSON(e)) : [] };
    },
    toJSON(message) {
        const obj = {};
    ...
    create(base) {
        return exports.QueryDelegatorTotalDelegationBalanceResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseQueryDelegatorTotalDelegationBalanceResponse();
...
class QueryClientImpl {
    constructor(rpc) {
        ...
        this.RedelegationsOfDelegator = this.RedelegationsOfDelegator.bind(this);
        this.DelegatorValidators = this.DelegatorValidators.bind(this);
        this.DelegatorValidator = this.DelegatorValidator.bind(this);
        this.DelegatorTotalDelegationBalance = this.DelegatorTotalDelegationBalance.bind(this);
    ...
    RedelegationsOfDelegator(request, metadata) {
        return this.rpc.unary(exports.QueryRedelegationsOfDelegatorDesc, exports.QueryRedelegationsRequest.fromPartial(request), metadata);
    }
    ...
    DelegatorTotalDelegationBalance(request, metadata) {
        return this.rpc.unary(exports.QueryDelegatorTotalDelegationBalanceDesc, exports.QueryDelegatorTotalDelegationBalanceRequest.fromPartial(request), metadata);
    }
...
exports.QueryRedelegationsOfDelegatorDesc = {
...
exports.QueryDelegatorTotalDelegationBalanceDesc = {
    ...
    requestType: {
        serializeBinary() {
            return exports.QueryDelegatorTotalDelegationBalanceRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
            const value = exports.QueryDelegatorTotalDelegationBalanceResponse.decode(data);
            return {
                ...value,
                toObject() {
                    return value;
