...
exports.StakeAuthorization = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.allowList !== undefined) {
            exports.StakeAuthorization_Validators.encode(message.allowList, writer.uint32(18).fork()).join();
        }
        if (message.denyList !== undefined) {
            exports.StakeAuthorization_Validators.encode(message.denyList, writer.uint32(26).fork()).join();
        }
    ...
    fromJSON(object) {
        return {
            maxTokens: gt.Array.isArray(object?.maxTokens) ? object.maxTokens.map((e) => coin_1.Coin.fromJSON(e)) : [],
