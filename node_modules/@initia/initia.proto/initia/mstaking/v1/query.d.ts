 ...
 */
export interface QueryDelegatorTotalDelegationBalanceRequest {
    /** delegator_addr defines the delegator address to query for. */
    delegatorAddr: string;
    /**
     * status enables to query for delegations with validators of a specific bond status (bonded/unbonded/unbonding).
 ...
 * Query/DelegatorTotalDelegationBalance RPC method.
 */
export interface QueryDelegatorTotalDelegationBalanceResponse {
...
export declare const QueryDelegatorTotalDelegationBalanceRequest: MessageFns<QueryDelegatorTotalDelegationBalanceRequest>;
export declare const QueryDelegatorTotalDelegationBalanceResponse: MessageFns<QueryDelegatorTotalDelegationBalanceResponse>;
...
export interface Query {
    ...
    RedelegationsOfDelegator(request: DeepPartial<QueryRedelegationsRequest>, metadata?: grpc.Metadata): Promise<QueryRedelegationsResponse>;
    /**
     ...
     * delegator.
     */
    DelegatorTotalDelegationBalance(request: DeepPartial<QueryDelegatorTotalDelegationBalanceRequest>, metadata?: grpc.Metadata): Promise<QueryDelegatorTotalDelegationBalanceResponse>;
...
export declare const QueryRedelegationsOfDelegatorDesc: UnaryMethodDefinitionish;
...
export declare const QueryDelegatorTotalDelegationBalanceDesc: UnaryMethodDefinitionish;
