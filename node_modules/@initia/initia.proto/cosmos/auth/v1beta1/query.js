...
exports.QueryModuleAccountsResponse = {
    ...
    fromJSON(object) {
        return { accounts: gt.Array.isArray(object?.accounts) ? object.accounts.map((e) => any_1.Any.fromJSON(e)) : [] };
    },
    toJSON(message) {
        const obj = {};
        if (message.accounts?.length) {
...
exports.QueryAccountInfoResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.info !== undefined) {
            auth_1.BaseAccount.encode(message.info, writer.uint32(10).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
