...
exports.Block = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.data !== undefined) {
            types_1.Data.encode(message.data, writer.uint32(18).fork()).join();
        }
        if (message.evidence !== undefined) {
            evidence_1.EvidenceList.encode(message.evidence, writer.uint32(26).fork()).join();
        }
        if (message.lastCommit !== undefined) {
            types_1.Commit.encode(message.lastCommit, writer.uint32(34).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
exports.Header = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.version !== undefined) {
            types_2.Consensus.encode(message.version, writer.uint32(10).fork()).join();
        }
        if (message.chainId !== "") {
        ...
        if (message.lastBlockId !== undefined) {
            types_1.BlockID.encode(message.lastBlockId, writer.uint32(42).fork()).join();
        }
