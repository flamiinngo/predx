...
exports.SignatureDescriptor = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.data !== undefined) {
            exports.SignatureDescriptor_Data.encode(message.data, writer.uint32(18).fork()).join();
        }
...
exports.SignatureDescriptor_Data = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.single !== undefined) {
            exports.SignatureDescriptor_Data_Single.encode(message.single, writer.uint32(10).fork()).join();
        }
        if (message.multi !== undefined) {
            exports.SignatureDescriptor_Data_Multi.encode(message.multi, writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
exports.SignatureDescriptor_Data_Multi = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        for (const v of message.signatures) {
            exports.SignatureDescriptor_Data.encode(v, writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
