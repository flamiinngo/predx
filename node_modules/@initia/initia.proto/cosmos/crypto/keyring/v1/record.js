...
exports.Record = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.local !== undefined) {
            exports.Record_Local.encode(message.local, writer.uint32(26).fork()).join();
        }
        if (message.ledger !== undefined) {
            exports.Record_Ledger.encode(message.ledger, writer.uint32(34).fork()).join();
        }
        if (message.multi !== undefined) {
            exports.Record_Multi.encode(message.multi, writer.uint32(42).fork()).join();
        }
        if (message.offline !== undefined) {
            exports.Record_Offline.encode(message.offline, writer.uint32(50).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
exports.Record_Local = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.privKey !== undefined) {
            any_1.Any.encode(message.privKey, writer.uint32(10).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
exports.Record_Ledger = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.path !== undefined) {
            hd_1.BIP44Params.encode(message.path, writer.uint32(10).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
