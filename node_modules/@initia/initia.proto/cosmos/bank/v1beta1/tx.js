...
exports.MsgUpdateParams = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.params !== undefined) {
            bank_1.Params.encode(message.params, writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
exports.MsgSetSendEnabled = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        for (const v of message.sendEnabled) {
            bank_1.SendEnabled.encode(v, writer.uint32(18).fork()).join();
        }
    ...
    fromJSON(object) {
        return {
            ...
            sendEnabled: gt.Array.isArray(object?.sendEnabled)
                ...
                : [],
            useDefaultFor: gt.Array.isArray(object?.useDefaultFor) ? object.useDefaultFor.map((e) => gt.String(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
